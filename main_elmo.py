...
parser.add_argument('--embedding_type', '-embedding', help="select the pretrained embedding", type= str,default='glove')
parser.add_argument('--sequence_length', '-sequence', help="select the word sequence length to the model", type= int,default=175)
parser.add_argument('--lr_rate', '-lr', help="-learning rate", type= float,default=0.001)
parser.add_argument('--optimizer', '-optimizer', help="select the optimzer", type= str)
parser.add_argument('--file_extension', '-file_extension', help="select the npy file_extension", type= str ,default='demo')
parser.add_argument('--dataset', '-dataset', help="select the Wiki dataset", type= str,default='toxicity')
parser.add_argument('--emb_dim', '-emb_dim', help="embedding dim", type=int ,default=300)
parser.add_argument('--hidden_dim', '-hidden_dim', help="hidden dimension", type=int ,default=150)
parser.add_argument('--model', '-model', help="model name", type=str ,default='CoAttn')
parser.add_argument('--epochs', '-epochs', help="epochs", type=int ,default=3)
parser.add_argument('--lstm_size', '-lstm_size', help="lstm size", type=int ,default=1)
parser.add_argument('--batch_size', '-batch_size', help="batch size", type=int ,default=256)
parser.add_argument('--dropout_prob', '-dropout_prob', help="dropout prob", type=float ,default=0)
